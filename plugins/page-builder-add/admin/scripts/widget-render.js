...
function customHeadingTextWidgetRender(
  this_widget_text,
  j,
  this_column,
  this_column_type,
  ...
  if (textWidgetContentHTML.includes("defaultELt")) {
    var textWidgetContentHTMLWrapped =
      " <" +
      widgetTextTag +
...
function imageWidgetRender(
  ...
  if (
    this_widget["iborderRadius"] != "undefined" &&
    this_widget["iborderRadius"] != null
  ) {
  ...
  if (
    this_widget["iborderWidth"] != "undefined" &&
    this_widget["iborderWidth"] != null
  ) {
  ...
  if (this_widget["imgwccdis"] != "hidden") {
    ...
    var imgTextEditingSaveTriggerBtn =
      "<div class='widget-" +
      j +
      " inlineEditingSaveTrigger ' style='display:none' data-wid_col_id='" +
      this_column +
...
function completeWidgetRender(
  ...
  switch (this_column_type) {
    ...
    case "wigt-btn-gen":
      ...
      btnButtonAlignmentTablet = btnButtonAlignment;
      btnButtonAlignmentMobile = btnButtonAlignment;
      ...
      allResponsiveScripts =
        allResponsiveScripts + currButtonWidgetResponsiveScripts;
