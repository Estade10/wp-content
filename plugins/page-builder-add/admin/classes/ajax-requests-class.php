		...
		if ( $nonce) {
			...
			if($requestMethod == 'GET') {
				...
				function cleanDataArray(&$value,$key,$allowed_html){
					...
					$contentKeysArr = array('accContent', 'widgetTextContent', 'wltc','fbTextContent','formCustomHTML','POcustomJS','widgetContent','formCustomHTML','pbPricingContent','content', 'btnText', 'columnContent');
					if(is_array($value)){
						return;
					}
